    ...
    run_agent(
        ...
        scorer=(
            ...
            .expect(
                agent_steps=2,
                tool_call_requests=1,
                tool_calls=[tool_call(name="github_create_pr", args_contains={"repo": "langchain-ai/deepagents"})],
            )
            .success(
    ...
    run_agent(
        ...
        scorer=(
            ...
            .expect(
                agent_steps=2,
                tool_call_requests=1,
                tool_calls=[tool_call(name="slack_post_channel", args_contains={"channel": "deployments"})],
            )
            .success(
    ...
    run_agent(
        ...
        scorer=(
            ...
            .expect(
                agent_steps=2,
                tool_call_requests=1,
                tool_calls=[tool_call(name="gmail_send_email", args_contains={"to": "manager@company.com"})],
            )
            .success(
