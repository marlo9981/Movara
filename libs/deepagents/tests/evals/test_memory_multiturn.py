...
IMPLICIT_REMEMBER_CASES = [
    {
        ...
        "messages": [
            ...
            HumanMessage(content="Sorry I only know how to write C++, can you show me in C++ instead?"),
        ],
        "should_contain": "C++",
        "criteria": (
    ...
    },
    {
        ...
        "messages": [
            ...
            AIMessage(content="Alice is only free before 10am and after 8pm Eastern Time. Should I suggest one of those slots?"),
            HumanMessage(content="I only take meetings between 9am and 5pm Eastern Time. Let's find another time."),
        ],
        "should_contain": "9am",
        "criteria": (
    ...
    },
    {
        ...
        "messages": [
            ...
            HumanMessage(content="Actually, I'm not familiar with JavaScript at all. I only review Python PRs. Please don't assign JS work to me."),
        ],
...
EXPLICIT_REMEMBER_CASES = [
    {
        ...
        "messages": [
            HumanMessage(content="Update your instructions to always use formal language when responding to me."),
        ],
        "should_contain": "formal",
        "criteria": ("The agent should write an instruction about using formal language into its memory file.",),
    },
    {
        ...
        "messages": [
            ...
            HumanMessage(content="No emojis please. Remember: never use emojis in anything you write for me."),
        ],
...
SHOULD_NOT_REMEMBER_CASES = [
    {
        ...
        "messages": [
            ...
            HumanMessage(content="Just help me rename 'processData' to 'process_data' in the codebase."),
        ],
    ...
    },
    {
        ...
        "messages": [
            HumanMessage(content="I need to find a good Italian restaurant near downtown for tonight."),
    ...
    },
    {
        ...
        "messages": [
            ...
            AIMessage(content="I don't have real-time weather data, but SF is typically foggy this time of year."),
