...
| [memory_agent](memory_agent/) | Agent that improves over time with learned global + per-user memory, sleep-time cron consolidation, and a day-N eval measuring improvement |
